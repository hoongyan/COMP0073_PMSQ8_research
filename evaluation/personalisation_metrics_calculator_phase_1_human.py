...
#             # Find police rows with victim_persona_appropriateness
#             police_rows = group[(group['sender_type'] == 'police') & (group['victim_persona_appropriateness (1-5)'].notna())]

#             scores = []
#             for _, row in police_rows.iterrows():
#                 persona_str = row['victim_persona_appropriateness (1-5)']
...
#     ie_csv = "simulations/phase_1/vanilla_rag/autonomous_conversation_history_rag_ie_evaluated.csv"  # Replace with actual path
...
if __name__ == "__main__":
    ie_csv = "simulations/phase_1/self_augmenting/autonomous_conversation_history_profile_rag_ie_kb_evaluated.csv"  # Replace with actual path
    victim_detail_json = "data/victim_profile/victim_details_human_eval.json"  # Replace with actual path
